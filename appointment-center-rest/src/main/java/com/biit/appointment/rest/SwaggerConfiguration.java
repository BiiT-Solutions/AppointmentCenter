...
public class SwaggerConfiguration extends DefaultSwaggerConfiguration {
    private static final String SWAGGER_TITLE = "AppointmentCenter";
    private static final String SWAGGER_DESCRIPTION = "";
    private static final String SWAGGER_GROUP = "rest-public";

    private static final String[] PACKAGES_TO_SCAN = new String[]{"com.biit.appointment.rest", "com.biit.server.rest", "com.biit.server.security.rest"};
