 ...
 */
public class AttendanceMonitoringLogger extends BasicLogger {

    private static final Logger LOGGER = LoggerFactory.getLogger(AttendanceMonitoringLogger.class);
