 ...
 */
public class AppointmentCenterClientLogger extends BasicLogger {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppointmentCenterClientLogger.class);
